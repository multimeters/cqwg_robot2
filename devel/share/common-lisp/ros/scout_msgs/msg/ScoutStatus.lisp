...
(cl:defmethod left_odomter-val ((m <ScoutStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_msgs-msg:left_odomter-val is deprecated.  Use scout_msgs-msg:left_odomter instead.")
  (left_odomter m))

(cl:ensure-generic-function 'right_odomter-val :lambda-list '(m))
(cl:defmethod right_odomter-val ((m <ScoutStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_msgs-msg:right_odomter-val is deprecated.  Use scout_msgs-msg:right_odomter instead.")
  (right_odomter m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ScoutStatus>)))
  ...
  "d22fec780b41f893296071c461742261")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ScoutStatus)))
  "Returns md5sum for a message object of type 'ScoutStatus"
  "d22fec780b41f893296071c461742261")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScoutStatus>)))
  ...
  (cl:format cl:nil "Header header~%~%int8 MOTOR_ID_FRONT_RIGHT = 0~%int8 MOTOR_ID_FRONT_LEFT = 1~%int8 MOTOR_ID_REAR_RIGHT = 2~%int8 MOTOR_ID_REAR_LEFT = 3~%~%int8 LIGHT_ID_FRONT = 0~%int8 LIGHT_ID_REAR = 1~%~%# motion state~%float64 linear_velocity~%float64 angular_velocity~%~%# base state~%uint8 base_state~%uint8 control_mode~%uint8 fault_code~%float64 battery_voltage~%~%# motor state~%ScoutMotorState[4] motor_states~%~%# light state~%bool light_control_enabled~%ScoutLightState front_light_state~%ScoutLightState rear_light_state~%~%# driver state~%ScoutDriverState[4] driver_states~%~%#odometer state~%float64 left_odomter~%float64 right_odomter~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: scout_msgs/ScoutMotorState~%float64 current~%float64 rpm~%float64 temperature~%float64 motor_pose~%~%================================================================================~%MSG: scout_msgs/ScoutLightState~%uint8 mode~%uint8 custom_value~%================================================================================~%MSG: scout_msgs/ScoutDriverState~%float64 driver_voltage~%float64 driver_temperature~%uint8   driver_state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScoutStatus)))
  "Returns full string definition for message of type 'ScoutStatus"
  (cl:format cl:nil "Header header~%~%int8 MOTOR_ID_FRONT_RIGHT = 0~%int8 MOTOR_ID_FRONT_LEFT = 1~%int8 MOTOR_ID_REAR_RIGHT = 2~%int8 MOTOR_ID_REAR_LEFT = 3~%~%int8 LIGHT_ID_FRONT = 0~%int8 LIGHT_ID_REAR = 1~%~%# motion state~%float64 linear_velocity~%float64 angular_velocity~%~%# base state~%uint8 base_state~%uint8 control_mode~%uint8 fault_code~%float64 battery_voltage~%~%# motor state~%ScoutMotorState[4] motor_states~%~%# light state~%bool light_control_enabled~%ScoutLightState front_light_state~%ScoutLightState rear_light_state~%~%# driver state~%ScoutDriverState[4] driver_states~%~%#odometer state~%float64 left_odomter~%float64 right_odomter~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: scout_msgs/ScoutMotorState~%float64 current~%float64 rpm~%float64 temperature~%float64 motor_pose~%~%================================================================================~%MSG: scout_msgs/ScoutLightState~%uint8 mode~%uint8 custom_value~%================================================================================~%MSG: scout_msgs/ScoutDriverState~%float64 driver_voltage~%float64 driver_temperature~%uint8   driver_state~%~%~%"))
